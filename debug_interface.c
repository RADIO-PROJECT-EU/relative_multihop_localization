...
void DebugIfWriteBdAddress2(const BD_ADDR_T *address)
{
    DebugWriteUint8(WORD_MSB(address->nap));
    DebugWriteString(":");
    DebugWriteUint8(WORD_LSB(address->nap));
    DebugWriteString(":");
    DebugWriteUint8(address->uap);
    DebugWriteString(":");
    DebugWriteUint8(WORD_LSB(address->lap >> 16));
    DebugWriteString(":");
    DebugWriteUint8(WORD_MSB(address->lap));
    DebugWriteString(":");
...
void AppDebugWriteInt2(int value)
{
    char valueString[6];
